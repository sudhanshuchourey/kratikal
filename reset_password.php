...
include("connection.php");
	if(isset($_POST["reset-password"])) {
		...
		$sql = "UPDATE `admin1` SET `Password` = '" .($_POST["member_password"]). "' WHERE `LoginID` = '" . $_GET["name"] . "'";
...
<div class="form">
	...
	<div class="field-group">
		...
		<div>
		<input type="password" placeholder=" New Password" name="member_password" id="member_password" class="input-field"></div>
	</div>
	
	<div class="field-group">
		
		<div><input type="password" placeholder="Confirm Password" name="confirm_password" id="confirm_password" class="input-field"></div>
	</div>
	
	<div class="field-group">
		<div><input type="submit" name="reset-password" id="reset-password" value="Reset Password" class="form-submit-button"><a href="index.php" style="color:#000">Login Now</a></div>
	</div>	
</form>
</div>
</form>
